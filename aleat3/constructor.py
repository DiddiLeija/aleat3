...
LIST_EXAMPLE = ["Option 1", "Option 2", "Option 3", "Option 4", "Option 5"]
COIN_NAME = "aleatory.coin"
    ...
    def first_given(self, how, /, repeat=True):
        ...
        if not isinstance(how, type(1)):
            ...
            if self.__mode == "Coin" and repeat is False:
                raise SyntaxError(f"'No-repetition' feature is not available for 'aleatory.coin' objects")
